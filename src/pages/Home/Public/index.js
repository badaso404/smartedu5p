  ...
  render() {
    return (
      ...
      <ScrollView>
        ...
        <View>
          <Image style={styles.Image} source={Feed1}></Image>
        </View>
        ...
        <View style={styles.caption}>
          <Text style={{fontFamily: 'TitilliumWeb-Bold'}}> SMAN 1 Solo</Text>
          <Text style={{fontFamily: 'TitilliumWeb-Regular'}}>
            ini adalah karya salah satu siswi dari SMAN 1 Solo yang berteme
            membuat gambar 1 objek ini adalah karya salah satu siswi dari SMAN 1
            Solo yang berteme membuat gambar 1 objek
          </Text>
        </View>
        ...
        <View style={styles.caption}>
          <Text style={{fontFamily: 'TitilliumWeb-Bold'}}> SMAN 1 Sukoharjo</Text>
          <Text style={{fontFamily: 'TitilliumWeb-Regular'}}>
            ini adalah karya salah satu siswi dari SMAN 1 Solo yang berteme
            membuat gambar 1 objek ini adalah karya salah satu siswi dari SMAN 1
            Solo yang berteme membuat gambar 1 objek
        ...
        <View style={styles.caption}>
          <Text style={{fontFamily: 'TitilliumWeb-Bold'}}> SMAN 3 Sukoharjo</Text>
          <Text style={{fontFamily: 'TitilliumWeb-Regular'}}>
            ini adalah karya salah satu siswi dari SMAN 1 Solo yang berteme
            membuat gambar 1 objek ini adalah karya salah satu siswi dari SMAN 1
            Solo yang berteme membuat gambar 1 objek
        ...
        <View style={styles.caption}>
          <Text style={{fontFamily: 'TitilliumWeb-Bold'}}> SMAN 2 Surakarta</Text>
          <Text style={{fontFamily: 'TitilliumWeb-Regular'}}>
            ini adalah karya salah satu siswi dari SMAN 1 Solo yang berteme
            membuat gambar 1 objek ini adalah karya salah satu siswi dari SMAN 1
            Solo yang berteme membuat gambar 1 objek
        ...
        <View style={styles.caption}>
          <Text style={{fontFamily: 'TitilliumWeb-Bold'}}> SMAN 1 Karanganyar</Text>
          <Text style={{fontFamily: 'TitilliumWeb-Regular'}}>
            ini adalah karya salah satu siswi dari SMAN 1 Solo yang berteme
            membuat gambar 1 objek ini adalah karya salah satu siswi dari SMAN 1
            Solo yang berteme membuat gambar 1 objek
